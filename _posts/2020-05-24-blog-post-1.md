---
title: 'Nginx high concurrency strategy'
date: 2020-05-24
...
The IO multiplexing techniques it uses depends on the operating system, for example, it uses *Epoll* module on Linux and *kqueue* on FreeBSD. This blog mainly analyze Nginx on Linux.
